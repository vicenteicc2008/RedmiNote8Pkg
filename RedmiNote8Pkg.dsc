...
################################################################################
[Defines]
  PLATFORM_NAME                  = RedmiNote8Pkg
  PLATFORM_GUID                  = 566ba710-0bee-48e0-b56e-dcf4b0a38e04
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/RedmiNote8Pkg-$(ARCH)
  SUPPORTED_ARCHITECTURES        = ARM
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = RedmiNote8Pkg/RedmiNote8Pkg.fdf
...
[PcdsFixedAtBuild.common]
  gEfiMdeModulePkgTokenSpaceGuid.PcdFirmwareVendor|L"WOA32 on ginkgo"
...
[LibraryClasses.common]
  ...
  ArmPlatformLib|RedmiNote8Pkg/Library/RedmiNote8Lib/RedmiNote8Lib.inf
  ...
  SerialPortLib|RedmiNote8Pkg/Library/FrameBufferSerialPortLib/FrameBufferSerialPortLib.inf
  MemoryInitPeiLib|RedmiNote8Pkg/Library/MemoryInitPeiLib/PeiMemoryAllocationLib.inf
  PlatformPeiLib|RedmiNote8Pkg/Library/PlatformPeiLib/PlatformPeiLib.inf
  PlatformBootManagerLib|RedmiNote8Pkg/Library/PlatformBootManagerLib/PlatformBootManagerLib.inf
...
[Components.common]
  ...
  # Graphics Driver
  RedmiNote8Pkg/Driver/SimpleFbDxe/SimpleFbDxe.inf
  ...
  RedmiNote8Pkg/Driver/LogoDxe/LogoDxe.inf
  ...
  # ACPI AND SMBIOS
  RedmiNote8Pkg/Driver/SmBiosTableDxe/SmBiosTableDxe.inf
  # Shell
